...
**インターンシップ生を受入れることにより、直接間接の広範な効果が見込まれます。受入機関から頂いた声をまとめると次のような効果があります。**
...
併せて、来日学生にとっては言語や習慣の違う環境に滞在し、自国以外の文化を学ぶ機会が得られることは言うまでもありません。
...
2. 受入機関が予め学生とインターンシップについて合意し、それを IAESTE の仕組みを利用して行うことができます。これを`リザーブドオファー`と呼び、その手数料を申し受けます。
3. 受入機関は研修中の滞在施設 (例えば独身寮等) を用意することが原則となっていますが、ご無理な場合は、シェアハウスを紹介致します。その場合には手数料を申し受けます。
