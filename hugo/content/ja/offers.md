...
英語能力のスコア最低条件は、応募時に選択したオファータイプに依ります。
...
*1: TOEFL iBT は2026年1月に表示方法が変更されたため、当面は変更前に取得した点数での応募も可とします。但し、受入機関から新スコアを求められることを想定し、ノミネーション書類送付時までに新スコアを取得することを強くお勧めします。
