...
| オファータイプ | メリット | デメリット |
| ---------- | ----- | ------ |
| **Exchange Internship** | <ul><li>他の応募者 (競争相手) がいない</li><li>必要なスキルを満たしていれば受入れ可になる可能性が非常に高い</li><li>仮に受入不可、またはオファー自体が何らかの理由でキャンセルとなった場合は Global Internship から希望のオファーを探すことができる</li> | <ul><li>国を選べない</li><li>研修内容までは選べないため期待どおりでない場合がある</li><li>希望分野と希望期間に合うオファーが第1希望地域にない場合は第2希望か第3希望の地域になる</li><li>最初にアサインされたオファーは基本的に拒否することはできない (その国が渡航危険状態になった場合などを除く)</li></ul> |
...
英語能力のスコア最低条件は、応募時に選択したオファータイプに依ります。<br>
...
| **IELTS** | 5.5  | 6.5  |
| **ケンブリッジ英語検定** | B2 First | C1 Advanced |
| **実用英語技能検定** | 準1級 | 準1級 |
| **TOEIC Listening and Reading** | 650 | 785 |

*1:TOEFL iBTは2026年1月に表示方法が変更されたため、当面は変更前に取得した点数での応募も可とします。但し、受入機関から新スコアを求められることを想定し、ノミネーション書類送付時までに新スコアを取得することを強くお勧めします。<br>

### 応募後の英語能力に関する留意事項
1. 海外の IAESTE は TOEFL、IELTS、またはケンブリッジ英語検定で英語能力を評価するケースが多いです。
2. 受入国によっては Speaking や Writing の証明が必須です。TOEIC Listening and Reading の証明しか持っていない場合、追加の面談による認定か、異なる試験の受験が必要になります。この場合は事務局より追って連絡があります。
3. 応募時に必要なスコアは上記の通りですが、受入機関が研修生にインタビューを行い受入可否を決める場合などで、実践的な能力が必要です。
...
あなたが入力した情報を IAESTE Japan が確認することで、アカウントが作成されます。<br>
