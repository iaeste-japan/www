...
> 2. 9月募集と4月募集では、研修可能時期や選択できるオファーの種類が異なります。詳しくは [研修を始めるまで](how-it-works.md) をご参照ください。
...
1. 2026年9月募集は終了しました。現在、[応募ポータル](https://application-portal.iaeste.or.jp) から新規に応募することはできません。既に作られたアカウントは引き続き閲覧に利用できます。
2. 応募方法や研修開始までの流れは、2026年9月の募集に関する[応募マニュアル（9月の応募用）](/files/internship/required-docs/application-manual-september-ja-v20260901.pdf)を参考にしてください。4月募集は9月募集と一部内容が異なりますので、応募の際は今後掲載予定の「応募マニュアル（4月の応募用）」をご確認ください。
4. [IAESTEハンドブック](/files/internship/required-docs/iaeste-handbook-ja-v20260901.pdf)は IAESTE と海外研修の概要や特徴、オファーのサンプルなど応募に当たって必要な情報を掲載しています。応募時に必ず参照してください。
...
| [IAESTEハンドブック](/files/internship/required-docs/iaeste-handbook-ja-v20260901.pdf) | .pdf | 2026-09-01 |
