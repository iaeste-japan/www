...
1. 応募する際は [応募ポータル](https://application-portal.iaeste.or.jp) から申し込んでください。但し、2026年9月の応募期間が終了したため、現在は既存アカウントの閲覧のみが可能です。
2. 応募に関しては、「応募マニュアル（9月の応募用）」をご覧ください。応募方法の他、研修開始までの流れが説明されています。なお、4月募集の詳細については、今後掲載予定の「応募マニュアル（4月の応募用）」をご参照ください。
3. 「IAESTEハンドブック」はIAESTEと海外研修の概要や特徴など応募に当たって必要な情報を掲載しています。応募時に必ず参照してください。
